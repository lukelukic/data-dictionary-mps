...
/*package*/ class DataDictionary_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_r8s0uu_a2a() {
    return (int) DataDictionary__BehaviorDescriptor.getAggregationNumbers_idsn6QynwAX5.invoke(myNode) > 0;
  }
  ...
  private boolean nodeCondition_r8s0uu_a4a() {
    return (int) DataDictionary__BehaviorDescriptor.getExSpecNumber_id1K8UrSXETi6.invoke(myNode) > 0;
  }
  ...
  private EditorCell createReadOnlyModelAccessor_1() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor() {
      public String getText() {
        return (int) DataDictionary__BehaviorDescriptor.getAggregationNumbers_idsn6QynwAX5.invoke(myNode) + "";
      }
      public void setText(String s) {
      }
      public boolean isValidText(String s) {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_r8s0uu_b2a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.EDITABLE, false);
    editorCell.getStyle().putAll(style);
    return editorCell;
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_r8s0uu_c2a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.ITALIC);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_7() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Ex. Specs (");
    editorCell.setCellId("Constant_r8s0uu_a4a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.ITALIC);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createReadOnlyModelAccessor_3() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor() {
      public String getText() {
        return (int) DataDictionary__BehaviorDescriptor.getExSpecNumber_id1K8UrSXETi6.invoke(myNode) + "";
      }
      public void setText(String s) {
      }
      public boolean isValidText(String s) {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_r8s0uu_b4a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.EDITABLE, false);
    editorCell.getStyle().putAll(style);
    return editorCell;
  ...
  private EditorCell createConstant_8() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_r8s0uu_c4a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.ITALIC);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createCollection_6() {
    ...
    if (nodeCondition_r8s0uu_a1f0()) {
      editorCell.addEditorCell(createReadOnlyModelAccessor_4());
    }
    editorCell.addEditorCell(createConstant_10());
    return editorCell;
  }
  private boolean nodeCondition_r8s0uu_a1f0() {
    return (int) DataDictionary__BehaviorDescriptor.getNonExNumber_id1K8UrSXFanD.invoke(myNode) > 0;
  }
  private EditorCell createConstant_9() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Non. Ex. Specs (");
  ...
  private EditorCell createReadOnlyModelAccessor_4() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor() {
      public String getText() {
        return (int) DataDictionary__BehaviorDescriptor.getNonExNumber_id1K8UrSXFanD.invoke(myNode) + "";
      }
      public void setText(String s) {
      }
      public boolean isValidText(String s) {
    ...
    editorCell.setAction(CellActionType.DELETE, EmptyCellAction.getInstance());
    editorCell.setAction(CellActionType.BACKSPACE, EmptyCellAction.getInstance());
    editorCell.setCellId("ReadOnlyModelAccessor_r8s0uu_b5a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.EDITABLE, false);
    editorCell.getStyle().putAll(style);
    return editorCell;
  ...
  private EditorCell createConstant_10() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_r8s0uu_c5a");
    Style style = new StyleImpl();
    style.set(StyleAttributes.FONT_STYLE, MPSFonts.ITALIC);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private static class structuresListHandler_r8s0uu_h0 extends RefNodeListHandler {
    ...
    private EditorCell createConstant_12() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "There are currently no structures.");
